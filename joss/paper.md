...
<!-- especially when coupled with TauREx's GPU-accelerated forward models [@Al-Refaie:2020]. -->
...
: Sampling times of the retrievals with `emcee` and `MultiNest` samplers. \label{tab:times}
