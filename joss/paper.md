---
title: '`taurex-emcee`: automated, parallelized atmospheric retrievals with TauREx 3.1 and the `emcee` sampler'
tags:
  - Python
  - astronomy
  - exoplanets
