...
from taurex_emcee import __version__, __author__, __pkg_name__

release = version = str(__version__)

project = __pkg_name__.upper()
copyright = "2023-{:d}, {}".format(date.today().year, __author__)
...
intersphinx_mapping = {
    ...
    "arviz": ("https://www.arviz.org/en/latest/", None),
}
...
htmlhelp_basename = "taurex_emcee"
...
# html_css_files = ["_static/taurex_emcee.css"]
...
latex_documents = [
    (
        ...
        "taurex_emcee.tex",
        "taurex-emcee Manual",
        "Andrea Bocchieri, Quentin Changeat, Lorenzo V. Mugnai, Enzo Pascale",
        "manual",
    )
]
